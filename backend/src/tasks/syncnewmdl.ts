...
/*
 * Generates local Mini Data Lake database.
 */

const MINI_DATA_LAKE_SCHEMA = `
--
...
--
-- Name: public; Type: SCHEMA; Schema: -; Owner: mdl_local
--
...
--
-- Name: alembic_version; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.alembic_version OWNER TO mdl_local;

--
-- Name: alias; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.alias OWNER TO mdl_local;

--
-- Name: api_key; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.api_key OWNER TO mdl_local;

--
-- Name: assessment; Type: TABLE; Schema: public; Owner: mdl_local
--
...
CREATE TABLE public.assessment (
    ...
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL,
    rsc_id character varying(255) NOT NULL,
    type character varying(255) NOT NULL,
    user_id uuid
);


ALTER TABLE public.assessment OWNER TO mdl_local;

--
-- Name: asset_headers; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.asset_headers OWNER TO mdl_local;

--
-- Name: category; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.category OWNER TO mdl_local;

--
-- Name: cidr; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.cidr OWNER TO mdl_local;

--
-- Name: cidr_organizations; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.cidr_organizations OWNER TO mdl_local;

--
-- Name: cidr_organizations_id_seq; Type: SEQUENCE; Schema: public; Owner: mdl_local
--
...
--
-- Name: cpe; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.cpe OWNER TO mdl_local;

--
-- Name: cpe_product_mdl; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.cpe_product_mdl OWNER TO mdl_local;

--
-- Name: cpe_product_mdl_cves; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.cpe_product_mdl_cves OWNER TO mdl_local;

--
-- Name: cpe_product_mdl_cves_id_seq; Type: SEQUENCE; Schema: public; Owner: mdl_local
--
...
--
-- Name: cpe_vender; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.cpe_vender OWNER TO mdl_local;

--
-- Name: credential_breaches; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.credential_breaches OWNER TO mdl_local;

--
-- Name: credential_exposures; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.credential_exposures OWNER TO mdl_local;

--
-- Name: cve; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.cve OWNER TO mdl_local;

--
-- Name: cve_cpes; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.cve_cpes OWNER TO mdl_local;

--
-- Name: cve_cpes_id_seq; Type: SEQUENCE; Schema: public; Owner: mdl_local
--
...
--
-- Name: cyhy_contacts; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.cyhy_contacts OWNER TO mdl_local;

--
-- Name: cyhy_db_assets; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.cyhy_db_assets OWNER TO mdl_local;

--
-- Name: cyhy_kevs; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.cyhy_kevs OWNER TO mdl_local;

--
-- Name: data_source; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.data_source OWNER TO mdl_local;

--
-- Name: django_migrations; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.django_migrations OWNER TO mdl_local;

--
-- Name: django_migrations_id_seq; Type: SEQUENCE; Schema: public; Owner: mdl_local
--
...
--
-- Name: dmz_mini_dl_vulnscan; Type: TABLE; Schema: public; Owner: mdl_local
--

CREATE TABLE public.dmz_mini_dl_vulnscan (
...
ALTER TABLE public.dmz_mini_dl_vulnscan OWNER TO mdl_local;

--
-- Name: dns_records; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.dns_records OWNER TO mdl_local;

--
-- Name: domain_alerts; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.domain_alerts OWNER TO mdl_local;

--
-- Name: domain_permutations; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.domain_permutations OWNER TO mdl_local;

--
-- Name: dotgov_domains; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.dotgov_domains OWNER TO mdl_local;

--
-- Name: executives; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.executives OWNER TO mdl_local;

--
-- Name: host; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.host OWNER TO mdl_local;

--
-- Name: ip; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.ip OWNER TO mdl_local;

--
-- Name: ip_sub_domains; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.ip_sub_domains OWNER TO mdl_local;

--
-- Name: ip_sub_domains_id_seq; Type: SEQUENCE; Schema: public; Owner: mdl_local
--
...
--
-- Name: location; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.location OWNER TO mdl_local;

--
-- Name: mentions; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.mentions OWNER TO mdl_local;

--
-- Name: notification; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.notification OWNER TO mdl_local;

--
-- Name: org_id_map; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.org_id_map OWNER TO mdl_local;

--
-- Name: org_id_map_id_seq; Type: SEQUENCE; Schema: public; Owner: mdl_local
--
...
--
-- Name: org_type; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.org_type OWNER TO mdl_local;

--
-- Name: organization; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.organization OWNER TO mdl_local;

--
-- Name: organization_tag; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.organization_tag OWNER TO mdl_local;

--
-- Name: organization_tag_organization; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.organization_tag_organization OWNER TO mdl_local;

--
-- Name: organization_tag_organization_id_seq; Type: SEQUENCE; Schema: public; Owner: mdl_local
--
...
--
-- Name: pe_report_summary_stats; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.pe_report_summary_stats OWNER TO mdl_local;

--
-- Name: pe_team_members; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.pe_team_members OWNER TO mdl_local;

--
-- Name: pe_users; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.pe_users OWNER TO mdl_local;

--
-- Name: port_scan; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.port_scan OWNER TO mdl_local;

--
-- Name: pshtt_results; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.pshtt_results OWNER TO mdl_local;

--
-- Name: query-result-cache; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public."query-result-cache" OWNER TO mdl_local;

--
-- Name: question; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.question OWNER TO mdl_local;

--
-- Name: resource; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.resource OWNER TO mdl_local;

--
-- Name: resource_questions; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.resource_questions OWNER TO mdl_local;

--
-- Name: resource_questions_id_seq; Type: SEQUENCE; Schema: public; Owner: mdl_local
--

ALTER TABLE public.resource_questions ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.resource_questions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: response; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.response OWNER TO mdl_local;

--
-- Name: role; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.role OWNER TO mdl_local;

--
-- Name: root_domains; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.root_domains OWNER TO mdl_local;

--
-- Name: saved_search; Type: TABLE; Schema: public; Owner: mdl_local
--
...
CREATE TABLE public.saved_search (
    ...
    create_vulnerabilities boolean NOT NULL,
    vulnerability_template jsonb NOT NULL,
    created_by_id uuid
);


ALTER TABLE public.saved_search OWNER TO mdl_local;

--
-- Name: scan; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.scan OWNER TO mdl_local;

--
-- Name: scan_organization_tags; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.scan_organization_tags OWNER TO mdl_local;

--
-- Name: scan_organization_tags_id_seq; Type: SEQUENCE; Schema: public; Owner: mdl_local
--
...
--
-- Name: scan_organizations; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.scan_organizations OWNER TO mdl_local;

--
-- Name: scan_organizations_id_seq; Type: SEQUENCE; Schema: public; Owner: mdl_local
--
...
--
-- Name: scan_task; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.scan_task OWNER TO mdl_local;

--
-- Name: scan_task_organization_tags; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.scan_task_organization_tags OWNER TO mdl_local;

--
-- Name: scan_task_organization_tags_id_seq; Type: SEQUENCE; Schema: public; Owner: mdl_local
--
...
--
-- Name: sector; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.sector OWNER TO mdl_local;

--
-- Name: sector_organizations; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.sector_organizations OWNER TO mdl_local;

--
-- Name: sector_organizations_id_seq; Type: SEQUENCE; Schema: public; Owner: mdl_local
--
...
--
-- Name: service; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.service OWNER TO mdl_local;

--
-- Name: shodan_assets; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.shodan_assets OWNER TO mdl_local;

--
-- Name: shodan_vulns; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.shodan_vulns OWNER TO mdl_local;

--
-- Name: sixgill_alerts; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.sixgill_alerts OWNER TO mdl_local;

--
-- Name: sub_domains; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.sub_domains OWNER TO mdl_local;

--
-- Name: ticket; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.ticket OWNER TO mdl_local;

--
-- Name: ticket_event; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.ticket_event OWNER TO mdl_local;

--
-- Name: top_cves; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.top_cves OWNER TO mdl_local;

--
-- Name: topic_totals; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.topic_totals OWNER TO mdl_local;

--
-- Name: unique_software; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.unique_software OWNER TO mdl_local;

--
-- Name: user; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public."user" OWNER TO mdl_local;

--
-- Name: vulnerability; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.vulnerability OWNER TO mdl_local;

--
-- Name: was_findings; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.was_findings OWNER TO mdl_local;

--
-- Name: was_history; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.was_history OWNER TO mdl_local;

--
-- Name: was_history_id_seq; Type: SEQUENCE; Schema: public; Owner: mdl_local
--
...
--
-- Name: was_map; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.was_map OWNER TO mdl_local;

--
-- Name: was_report; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.was_report OWNER TO mdl_local;

--
-- Name: was_report_id_seq; Type: SEQUENCE; Schema: public; Owner: mdl_local
--
...
--
-- Name: was_tracker_customer_data; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.was_tracker_customer_data OWNER TO mdl_local;

--
-- Name: web_assets; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.web_assets OWNER TO mdl_local;

--
-- Name: webpage; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.webpage OWNER TO mdl_local;

--
-- Name: weekly_statuses_mdl; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.weekly_statuses_mdl OWNER TO mdl_local;

--
-- Name: xpanse_alerts_mdl; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.xpanse_alerts_mdl OWNER TO mdl_local;

--
-- Name: xpanse_alerts_mdl_assets; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.xpanse_alerts_mdl_assets OWNER TO mdl_local;

--
-- Name: xpanse_alerts_mdl_assets_id_seq; Type: SEQUENCE; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_alerts_mdl_business_units; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.xpanse_alerts_mdl_business_units OWNER TO mdl_local;

--
-- Name: xpanse_alerts_mdl_business_units_id_seq; Type: SEQUENCE; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_alerts_mdl_services; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.xpanse_alerts_mdl_services OWNER TO mdl_local;

--
-- Name: xpanse_alerts_mdl_services_id_seq; Type: SEQUENCE; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_assets_mdl; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.xpanse_assets_mdl OWNER TO mdl_local;

--
-- Name: xpanse_business_units; Type: TABLE; Schema: public; Owner: mdl_local
--
...
CREATE TABLE public.xpanse_business_units (
    ...
    region text,
    rating integer,
    cyhy_db_name character varying(255) NOT NULL
);


ALTER TABLE public.xpanse_business_units OWNER TO mdl_local;

--
-- Name: xpanse_cve_services_mdl; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.xpanse_cve_services_mdl OWNER TO mdl_local;

--
-- Name: xpanse_cve_services_mdl_id_seq; Type: SEQUENCE; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_cves_mdl; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.xpanse_cves_mdl OWNER TO mdl_local;

--
-- Name: xpanse_services_mdl; Type: TABLE; Schema: public; Owner: mdl_local
--
...
ALTER TABLE public.xpanse_services_mdl OWNER TO mdl_local;

--
-- Name: alembic_version alembic_version_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: alias alias_alias_key; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: alias alias_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: api_key api_key_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: assessment assessment_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: assessment assessment_rsc_id_key; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--

ALTER TABLE ONLY public.assessment
    ADD CONSTRAINT assessment_rsc_id_key UNIQUE (rsc_id);


--
-- Name: asset_headers asset_headers_organization_uid_sub_url_8d9a71c3_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: asset_headers asset_headers_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: category category_number_key; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--

ALTER TABLE ONLY public.category
    ADD CONSTRAINT category_number_key UNIQUE (number);


--
-- Name: category category_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: cidr cidr_network_key; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: cidr_organizations cidr_organizations_cidr_id_organization_id_e948710c_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: cidr_organizations cidr_organizations_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: cidr cidr_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: cpe cpe_name_version_vendor_a54bda44_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: cpe cpe_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: cpe_product_mdl cpe_product_mdl_cpe_product_name_version_number_f8bf94e4_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: cpe_product_mdl_cves cpe_product_mdl_cves_cpeproduct_id_cve_id_521ae991_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: cpe_product_mdl_cves cpe_product_mdl_cves_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: cpe_product_mdl cpe_product_mdl_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: cpe_vender cpe_vender_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: cpe_vender cpe_vender_vender_name_key; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: credential_breaches credential_breaches_breach_name_key; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: credential_breaches credential_breaches_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: credential_exposures credential_exposures_breach_name_email_33cf2058_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: credential_exposures credential_exposures_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: cve_cpes cve_cpes_cve_id_cpe_id_9833ab3e_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: cve_cpes cve_cpes_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: cve cve_name_key; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: cve cve_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: cyhy_contacts cyhy_contacts_org_id_contact_type_email_name_92b85c52_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: cyhy_contacts cyhy_contacts_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: cyhy_db_assets cyhy_db_assets_org_id_network_4642b081_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: cyhy_db_assets cyhy_db_assets_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: cyhy_kevs cyhy_kevs_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: data_source data_source_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: django_migrations django_migrations_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: dmz_mini_dl_vulnscan dmz_mini_dl_vulnscan_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--

ALTER TABLE ONLY public.dmz_mini_dl_vulnscan
    ADD CONSTRAINT dmz_mini_dl_vulnscan_pkey PRIMARY KEY (id);


--
-- Name: dns_records dns_records_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: domain_alerts domain_alerts_alert_type_sub_domain_ui_cfa006d2_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: domain_alerts domain_alerts_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: domain_permutations domain_permutations_domain_permutation_organ_15048e3e_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: domain_permutations domain_permutations_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: dotgov_domains dotgov_domains_domain_name_key; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: dotgov_domains dotgov_domains_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: executives executives_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: host host_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: ip ip_ip_organization_id_61503db1_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: ip ip_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: ip_sub_domains ip_sub_domains_ip_id_subdomains_id_94d06e84_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: ip_sub_domains ip_sub_domains_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: location location_gnis_id_key; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: location location_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: mentions mentions_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: mentions mentions_sixgill_mention_id_key; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: notification notification_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: org_id_map org_id_map_cyhy_id_pe_org_id_b580d6d5_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: org_id_map org_id_map_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: org_type org_type_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: organization organization_acronym_key; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: organization organization_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: organization_tag organization_tag_name_key; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: organization_tag_organization organization_tag_organiz_organizationtag_id_organ_80ba4ec6_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: organization_tag_organization organization_tag_organization_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: organization_tag organization_tag_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: pe_report_summary_stats pe_report_summary_stats_organization_uid_start_d_66dd3af0_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: pe_report_summary_stats pe_report_summary_stats_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: pe_team_members pe_team_members_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: pe_users pe_users_api_key_key; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: pe_users pe_users_email_key; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: pe_users pe_users_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: pe_users pe_users_username_key; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: port_scan port_scan_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: pshtt_results pshtt_results_organization_uid_sub_domain_81ce555c_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: pshtt_results pshtt_results_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: query-result-cache query-result-cache_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: question question_category_id_number_2f9972a3_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--

ALTER TABLE ONLY public.question
    ADD CONSTRAINT question_category_id_number_2f9972a3_uniq UNIQUE (category_id, number);


--
-- Name: question question_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: resource resource_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: resource_questions resource_questions_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: resource_questions resource_questions_resource_id_question_id_ac9c74ee_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--

ALTER TABLE ONLY public.resource_questions
    ADD CONSTRAINT resource_questions_resource_id_question_id_ac9c74ee_uniq UNIQUE (resource_id, question_id);


--
-- Name: resource resource_url_key; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: response response_assessment_id_question_id_4796abb0_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--

ALTER TABLE ONLY public.response
    ADD CONSTRAINT response_assessment_id_question_id_4796abb0_uniq UNIQUE (assessment_id, question_id);


--
-- Name: response response_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: role role_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: role role_user_id_organization_id_3c3ad6d7_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: root_domains root_domains_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: root_domains root_domains_root_domain_organization_uid_bf1e861d_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: saved_search saved_search_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: scan_organization_tags scan_organization_tags_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: scan_organization_tags scan_organization_tags_scan_id_organizationtag_id_593ecf52_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: scan_organizations scan_organizations_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: scan_organizations scan_organizations_scan_id_organization_id_fed32cfc_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: scan scan_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: scan_task_organization_tags scan_task_organization_t_scantask_id_organization_8ceb48da_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: scan_task_organization_tags scan_task_organization_tags_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: scan_task scan_task_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: sector sector_acronym_key; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: sector_organizations sector_organizations_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: sector_organizations sector_organizations_sector_id_organization_id_c9a51e0f_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: sector sector_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: service service_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: service service_port_domain_id_e8df5226_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: shodan_assets shodan_assets_organization_ip_port_pro_3bd1419c_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--

ALTER TABLE ONLY public.shodan_assets
    ADD CONSTRAINT shodan_assets_organization_ip_port_pro_3bd1419c_uniq UNIQUE (organization, ip, port, protocol, "timestamp");


--
-- Name: shodan_assets shodan_assets_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: shodan_vulns shodan_vulns_organization_ip_port_pro_65a3a3eb_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--

ALTER TABLE ONLY public.shodan_vulns
    ADD CONSTRAINT shodan_vulns_organization_ip_port_pro_65a3a3eb_uniq UNIQUE (organization, ip, port, protocol, "timestamp");


--
-- Name: shodan_vulns shodan_vulns_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: sixgill_alerts sixgill_alerts_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: sixgill_alerts sixgill_alerts_sixgill_id_key; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: sub_domains sub_domains_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: sub_domains sub_domains_sub_domain_root_domain_uid_ee500437_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: ticket_event ticket_event_event_timestamp_ticket_id_action_d1d6974d_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: ticket_event ticket_event_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: ticket ticket_id_1f17c5d6_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: ticket ticket_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: top_cves top_cves_cve_id_date_7fa6a474_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: top_cves top_cves_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: topic_totals topic_totals_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: unique_software unique_software_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: user user_cognitoId_key; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: user user_email_key; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: user user_login_gov_id_key; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: user user_okta_id_key; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: user user_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: vulnerability vulnerability_domain_id_title_9d86fe67_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: vulnerability vulnerability_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: was_findings was_findings_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: was_history was_history_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: was_history was_history_was_org_id_date_scanned_8cf982b2_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: was_map was_map_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: was_report was_report_last_scan_date_org_was_acronym_5e5468bb_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: was_report was_report_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: was_tracker_customer_data was_tracker_customer_data_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: web_assets web_assets_asset_organization_uid_ed3b9b8a_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: web_assets web_assets_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: webpage webpage_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: webpage webpage_url_domain_id_81a87e5f_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: weekly_statuses_mdl weekly_statuses_mdl_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_alerts_mdl xpanse_alerts_mdl_alert_id_key; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_alerts_mdl_assets xpanse_alerts_mdl_assets_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_alerts_mdl_assets xpanse_alerts_mdl_assets_xpansealerts_id_xpanseas_b0e56dc1_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_alerts_mdl_business_units xpanse_alerts_mdl_busine_xpansealerts_id_xpansebu_8d3090a9_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_alerts_mdl_business_units xpanse_alerts_mdl_business_units_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_alerts_mdl xpanse_alerts_mdl_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_alerts_mdl_services xpanse_alerts_mdl_servic_xpansealerts_id_xpansese_03c93d63_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_alerts_mdl_services xpanse_alerts_mdl_services_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_assets_mdl xpanse_assets_mdl_asm_id_key; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_assets_mdl xpanse_assets_mdl_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_business_units xpanse_business_units_entity_name_key; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_business_units xpanse_business_units_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_cve_services_mdl xpanse_cve_services_mdl_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_cve_services_mdl xpanse_cve_services_mdl_xpanse_inferred_cve_id_x_99a754b9_uniq; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_cves_mdl xpanse_cves_mdl_cve_id_key; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_cves_mdl xpanse_cves_mdl_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_services_mdl xpanse_services_mdl_pkey; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_services_mdl xpanse_services_mdl_service_id_key; Type: CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: alembic_version_version_num_2efbf876_like; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: alias_alias_e67d6c6e_like; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: alias_organization_uid_bcc2cdb9; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: api_key_user_id_2b8305f7; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: assessment_rsc_id_f98f65e8_like; Type: INDEX; Schema: public; Owner: mdl_local
--

CREATE INDEX assessment_rsc_id_f98f65e8_like ON public.assessment USING btree (rsc_id varchar_pattern_ops);


--
-- Name: assessment_user_id_53d021c3; Type: INDEX; Schema: public; Owner: mdl_local
--

CREATE INDEX assessment_user_id_53d021c3 ON public.assessment USING btree (user_id);


--
-- Name: asset_headers_organization_uid_150c5556; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: category_number_b4ffdf99_like; Type: INDEX; Schema: public; Owner: mdl_local
--

CREATE INDEX category_number_b4ffdf99_like ON public.category USING btree (number varchar_pattern_ops);


--
-- Name: cidr_data_source_uid_e814595d; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: cidr_network_83f1f4_idx; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: cidr_organizations_cidr_id_44bd1393; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: cidr_organizations_organization_id_8ec1184d; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: cpe_product_mdl_cpe_vender_uid_5449d117; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: cpe_product_mdl_cves_cpeproduct_id_6f13cbdc; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: cpe_product_mdl_cves_cve_id_04b27219; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: cpe_vender_vender_name_b222af88_like; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: credential_breaches_breach_name_abddd57e_like; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: credential_breaches_data_source_uid_04e85c76; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: credential_exposures_credential_breaches_uid_3b485b9f; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: credential_exposures_data_source_uid_8fde1968; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: credential_exposures_organization_uid_12543cf9; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: cve_cpes_cpe_id_4f94803a; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: cve_cpes_cve_id_bd26db06; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: cve_name_80440c84_like; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: cyhy_contacts_organization_uid_fb9c5353; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: cyhy_db_assets_organization_uid_b2101a79; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: dmz_mini_dl_vulnscan_cve_id_6edb2b2b; Type: INDEX; Schema: public; Owner: mdl_local
--

CREATE INDEX dmz_mini_dl_vulnscan_cve_id_6edb2b2b ON public.dmz_mini_dl_vulnscan USING btree (cve_id);


--
-- Name: dmz_mini_dl_vulnscan_id_20ba638a_like; Type: INDEX; Schema: public; Owner: mdl_local
--

CREATE INDEX dmz_mini_dl_vulnscan_id_20ba638a_like ON public.dmz_mini_dl_vulnscan USING btree (id varchar_pattern_ops);


--
-- Name: dmz_mini_dl_vulnscan_ip_id_5fdb2777; Type: INDEX; Schema: public; Owner: mdl_local
--

CREATE INDEX dmz_mini_dl_vulnscan_ip_id_5fdb2777 ON public.dmz_mini_dl_vulnscan USING btree (ip_id);


--
-- Name: dmz_mini_dl_vulnscan_ip_id_5fdb2777_like; Type: INDEX; Schema: public; Owner: mdl_local
--

CREATE INDEX dmz_mini_dl_vulnscan_ip_id_5fdb2777_like ON public.dmz_mini_dl_vulnscan USING btree (ip_id text_pattern_ops);


--
-- Name: dmz_mini_dl_vulnscan_organization_id_ec11bd02; Type: INDEX; Schema: public; Owner: mdl_local
--

CREATE INDEX dmz_mini_dl_vulnscan_organization_id_ec11bd02 ON public.dmz_mini_dl_vulnscan USING btree (organization_id);


--
-- Name: domain_alerts_data_source_uid_a82a17ac; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: domain_alerts_sub_domain_uid_dbf29a19; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: domain_permutations_data_source_uid_da400900; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: domain_permutations_organization_uid_fdfc372d; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: domain_permutations_sub_domain_uid_a236d3ba; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: dotgov_domains_domain_name_3e4b1316_like; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: executives_organization_b9920fa6; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: host_id_916e03f4_like; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: host_ip_id_ef54cba9; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: host_ip_id_ef54cba9_like; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: host_ip_stri_b105ae_idx; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: host_organization_id_fbf51ac7; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: ip_ip_d6689a_idx; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: ip_ip_hash_6a25c4fc_like; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: ip_organization_id_241abc40; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: ip_origin_cidr_f9b724e9; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: ip_sub_domains_ip_id_079f6ccb; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: ip_sub_domains_ip_id_079f6ccb_like; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: ip_sub_domains_subdomains_id_681ba276; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: location_gnis_id_845f5b_idx; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: location_gnis_id_f0601589_like; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: mentions_data_source_uid_5c5f8bf8; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: mentions_sixgill_mention_id_fad7df53_like; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: organization_acronym_97d5f7cb_like; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: organization_created_by_id_35551e36; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: organization_location_id_067f8a89; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: organization_org_type_id_9d510ee1; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: organization_parent_id_981c8191; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: organization_tag_name_7322d41a_like; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: organization_tag_organization_organization_id_dcb828c9; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: organization_tag_organization_organizationtag_id_2a848187; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: pe_report_summary_stats_organization_uid_7704a098; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: pe_users_api_key_82aa3c4a_like; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: pe_users_email_6df55e0f_like; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: pe_users_username_f4890452_like; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: port_scan_id_8962dfc6_like; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: port_scan_ip_id_5ac3d203; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: port_scan_ip_id_5ac3d203_like; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: port_scan_organization_id_7a457e61; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: pshtt_results_data_source_uid_59849107; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: pshtt_results_organization_uid_58ebe095; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: question_category_id_c38e9303; Type: INDEX; Schema: public; Owner: mdl_local
--

CREATE INDEX question_category_id_c38e9303 ON public.question USING btree (category_id);


--
-- Name: resource_questions_question_id_48dbd5af; Type: INDEX; Schema: public; Owner: mdl_local
--

CREATE INDEX resource_questions_question_id_48dbd5af ON public.resource_questions USING btree (question_id);


--
-- Name: resource_questions_resource_id_02b60450; Type: INDEX; Schema: public; Owner: mdl_local
--

CREATE INDEX resource_questions_resource_id_02b60450 ON public.resource_questions USING btree (resource_id);


--
-- Name: resource_url_5ff49d5b_like; Type: INDEX; Schema: public; Owner: mdl_local
--

CREATE INDEX resource_url_5ff49d5b_like ON public.resource USING btree (url text_pattern_ops);


--
-- Name: response_assessment_id_2b257e65; Type: INDEX; Schema: public; Owner: mdl_local
--

CREATE INDEX response_assessment_id_2b257e65 ON public.response USING btree (assessment_id);


--
-- Name: response_question_id_9ed7eac9; Type: INDEX; Schema: public; Owner: mdl_local
--

CREATE INDEX response_question_id_9ed7eac9 ON public.response USING btree (question_id);


--
-- Name: role_approved_by_id_27a41bea; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: role_created_by_id_bffd5752; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: role_organization_id_d00f912a; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: role_user_id_8cace677; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: root_domains_data_source_uid_890b0a7e; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: root_domains_organization_uid_c75c3a9f; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: saved_search_created_by_id_f29cf571; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: scan_created_by_e45cf6fe; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: scan_organization_tags_organizationtag_id_1beaa19c; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: scan_organization_tags_scan_id_6cc5e82b; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: scan_organizations_organization_id_2e852548; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: scan_organizations_scan_id_f6f0b182; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: scan_task_organization_id_73d56e9e; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: scan_task_organization_tags_organizationtag_id_1aee59b1; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: scan_task_organization_tags_scantask_id_187d7073; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: scan_task_scan_id_be503edb; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: sector_acronym_34564b0a_like; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: sector_acronym_fd7c14_idx; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: sector_organizations_organization_id_a28a5990; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: sector_organizations_sector_id_dc248e70; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: service_discovered_by_id_5b0c28e9; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: service_domain_id_ed507973; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: shodan_assets_data_source_uid_acd993ab; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: shodan_vulns_data_source_uid_866c5b81; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: sixgill_alerts_data_source_uid_be876b69; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: sixgill_alerts_organization_uid_69a4a171; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: sixgill_alerts_sixgill_id_413b716f_like; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: sub_domains_data_source_uid_6fd21634; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: sub_domains_dns_record_uid_1e70b745; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: sub_domains_organization_uid_abe259f1; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: sub_domains_root_domain_uid_91cde39c; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: ticket_cve_id_cd0dbbf5; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: ticket_event_ticket_id_0244b672; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: ticket_event_ticket_id_0244b672_like; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: ticket_event_vuln_scan_id_7f408339; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: ticket_event_vuln_scan_id_7f408339_like; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: ticket_id_1f17c5d6_like; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: ticket_ip_id_3aa822df; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: ticket_ip_id_3aa822df_like; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: ticket_organization_id_3759c8ee; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: top_cves_data_source_uid_753ec315; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: user_cognitoId_1a343db2_like; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: user_email_54dc62b2_like; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: user_login_gov_id_2dc4e9fb_like; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: user_okta_id_144466d2_like; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: vulnerability_domain_id_396cdcf6; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: vulnerability_service_id_6cb061d7; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: was_map_was_org_id_be6a736e_like; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: web_assets_data_source_uid_716854de; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: web_assets_organization_uid_5893b6b0; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: webpage_discovered_by_id_d7969e8a; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: webpage_domain_id_59407f86; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_alerts_mdl_alert_id_7b6bc051_like; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_alerts_mdl_assets_xpansealerts_id_b8d2b7f7; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_alerts_mdl_assets_xpanseassetsmdl_id_551795c3; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_alerts_mdl_business_units_xpansealerts_id_c7cdac35; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_alerts_mdl_business_xpansebusinessunits_id_90fd8627; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_alerts_mdl_services_xpansealerts_id_65bfcebc; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_alerts_mdl_services_xpanseservicesmdl_id_0da6657e; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_assets_mdl_asm_id_f3e3f4d1_like; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_business_units_cyhy_db_name_76db20e6; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_business_units_cyhy_db_name_76db20e6_like; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_business_units_entity_name_91b35a02_like; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_cve_services_mdl_xpanse_inferred_cve_id_dcd2d4fe; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_cve_services_mdl_xpanse_service_id_fafe4f16; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_cves_mdl_cve_id_afd3dc4b_like; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_services_mdl_service_id_12ceccc0_like; Type: INDEX; Schema: public; Owner: mdl_local
--
...
--
-- Name: alias alias_organization_uid_bcc2cdb9_fk_organization_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: api_key api_key_user_id_2b8305f7_fk_user_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: assessment assessment_user_id_53d021c3_fk_user_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--

ALTER TABLE ONLY public.assessment
    ADD CONSTRAINT assessment_user_id_53d021c3_fk_user_id FOREIGN KEY (user_id) REFERENCES public."user"(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: asset_headers asset_headers_organization_uid_150c5556_fk_organization_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: cidr cidr_data_source_uid_e814595d_fk_data_source_data_source_uid; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: cidr_organizations cidr_organizations_cidr_id_44bd1393_fk_cidr_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: cidr_organizations cidr_organizations_organization_id_8ec1184d_fk_organization_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: cpe_product_mdl cpe_product_mdl_cpe_vender_uid_5449d117_fk_cpe_vende; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: cpe_product_mdl_cves cpe_product_mdl_cves_cpeproduct_id_6f13cbdc_fk_cpe_produ; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: cpe_product_mdl_cves cpe_product_mdl_cves_cve_id_04b27219_fk_cve_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: credential_breaches credential_breaches_data_source_uid_04e85c76_fk_data_sour; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: credential_exposures credential_exposures_credential_breaches__3b485b9f_fk_credentia; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: credential_exposures credential_exposures_data_source_uid_8fde1968_fk_data_sour; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: credential_exposures credential_exposures_organization_uid_12543cf9_fk_organizat; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: cve_cpes cve_cpes_cpe_id_4f94803a_fk_cpe_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: cve_cpes cve_cpes_cve_id_bd26db06_fk_cve_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: cyhy_contacts cyhy_contacts_organization_uid_fb9c5353_fk_organization_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: cyhy_db_assets cyhy_db_assets_organization_uid_b2101a79_fk_organization_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: dmz_mini_dl_vulnscan dmz_mini_dl_vulnscan_cve_id_6edb2b2b_fk_cve_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--

ALTER TABLE ONLY public.dmz_mini_dl_vulnscan
    ADD CONSTRAINT dmz_mini_dl_vulnscan_cve_id_6edb2b2b_fk_cve_id FOREIGN KEY (cve_id) REFERENCES public.cve(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: dmz_mini_dl_vulnscan dmz_mini_dl_vulnscan_ip_id_5fdb2777_fk_ip_ip_hash; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--

ALTER TABLE ONLY public.dmz_mini_dl_vulnscan
    ADD CONSTRAINT dmz_mini_dl_vulnscan_ip_id_5fdb2777_fk_ip_ip_hash FOREIGN KEY (ip_id) REFERENCES public.ip(ip_hash) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: dmz_mini_dl_vulnscan dmz_mini_dl_vulnscan_organization_id_ec11bd02_fk_organizat; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--

ALTER TABLE ONLY public.dmz_mini_dl_vulnscan
    ADD CONSTRAINT dmz_mini_dl_vulnscan_organization_id_ec11bd02_fk_organizat FOREIGN KEY (organization_id) REFERENCES public.organization(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: domain_alerts domain_alerts_data_source_uid_a82a17ac_fk_data_sour; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: domain_alerts domain_alerts_sub_domain_uid_dbf29a19_fk_sub_domai; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: domain_permutations domain_permutations_data_source_uid_da400900_fk_data_sour; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: domain_permutations domain_permutations_organization_uid_fdfc372d_fk_organizat; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: domain_permutations domain_permutations_sub_domain_uid_a236d3ba_fk_sub_domai; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: executives executives_organization_b9920fa6_fk_organization_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: host host_ip_id_ef54cba9_fk_ip_ip_hash; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: host host_organization_id_fbf51ac7_fk_organization_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: ip ip_organization_id_241abc40_fk_organization_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: ip ip_origin_cidr_f9b724e9_fk_cidr_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: ip_sub_domains ip_sub_domains_ip_id_079f6ccb_fk_ip_ip_hash; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: ip_sub_domains ip_sub_domains_subdomains_id_681ba276_fk_sub_domai; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: mentions mentions_data_source_uid_5c5f8bf8_fk_data_sour; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: organization organization_created_by_id_35551e36_fk_user_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: organization organization_location_id_067f8a89_fk_location_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: organization organization_org_type_id_9d510ee1_fk_org_type_org_type_uid; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: organization organization_parent_id_981c8191_fk_organization_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: organization_tag_organization organization_tag_org_organization_id_dcb828c9_fk_organizat; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: organization_tag_organization organization_tag_org_organizationtag_id_2a848187_fk_organizat; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: pe_report_summary_stats pe_report_summary_st_organization_uid_7704a098_fk_organizat; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: port_scan port_scan_ip_id_5ac3d203_fk_ip_ip_hash; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: port_scan port_scan_organization_id_7a457e61_fk_organization_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: pshtt_results pshtt_results_data_source_uid_59849107_fk_data_sour; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: pshtt_results pshtt_results_organization_uid_58ebe095_fk_organization_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: question question_category_id_c38e9303_fk_category_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--

ALTER TABLE ONLY public.question
    ADD CONSTRAINT question_category_id_c38e9303_fk_category_id FOREIGN KEY (category_id) REFERENCES public.category(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: resource_questions resource_questions_question_id_48dbd5af_fk_question_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--

ALTER TABLE ONLY public.resource_questions
    ADD CONSTRAINT resource_questions_question_id_48dbd5af_fk_question_id FOREIGN KEY (question_id) REFERENCES public.question(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: resource_questions resource_questions_resource_id_02b60450_fk_resource_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--

ALTER TABLE ONLY public.resource_questions
    ADD CONSTRAINT resource_questions_resource_id_02b60450_fk_resource_id FOREIGN KEY (resource_id) REFERENCES public.resource(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: response response_assessment_id_2b257e65_fk_assessment_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--

ALTER TABLE ONLY public.response
    ADD CONSTRAINT response_assessment_id_2b257e65_fk_assessment_id FOREIGN KEY (assessment_id) REFERENCES public.assessment(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: response response_question_id_9ed7eac9_fk_question_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--

ALTER TABLE ONLY public.response
    ADD CONSTRAINT response_question_id_9ed7eac9_fk_question_id FOREIGN KEY (question_id) REFERENCES public.question(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: role role_approved_by_id_27a41bea_fk_user_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: role role_created_by_id_bffd5752_fk_user_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: role role_organization_id_d00f912a_fk_organization_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: role role_user_id_8cace677_fk_user_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: root_domains root_domains_data_source_uid_890b0a7e_fk_data_sour; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: root_domains root_domains_organization_uid_c75c3a9f_fk_organization_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: saved_search saved_search_created_by_id_f29cf571_fk_user_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: scan scan_created_by_e45cf6fe_fk_user_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: scan_organization_tags scan_organization_ta_organizationtag_id_1beaa19c_fk_organizat; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: scan_organization_tags scan_organization_tags_scan_id_6cc5e82b_fk_scan_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: scan_organizations scan_organizations_organization_id_2e852548_fk_organization_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: scan_organizations scan_organizations_scan_id_f6f0b182_fk_scan_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: scan_task_organization_tags scan_task_organizati_organizationtag_id_1aee59b1_fk_organizat; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: scan_task_organization_tags scan_task_organizati_scantask_id_187d7073_fk_scan_task; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: scan_task scan_task_organization_id_73d56e9e_fk_organization_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: scan_task scan_task_scan_id_be503edb_fk_scan_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: sector_organizations sector_organizations_organization_id_a28a5990_fk_organizat; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: sector_organizations sector_organizations_sector_id_dc248e70_fk_sector_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: service service_discovered_by_id_5b0c28e9_fk_scan_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: service service_domain_id_ed507973_fk_sub_domains_sub_domain_uid; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: shodan_assets shodan_assets_data_source_uid_acd993ab_fk_data_sour; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: shodan_vulns shodan_vulns_data_source_uid_866c5b81_fk_data_sour; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: sixgill_alerts sixgill_alerts_data_source_uid_be876b69_fk_data_sour; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: sixgill_alerts sixgill_alerts_organization_uid_69a4a171_fk_organization_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: sub_domains sub_domains_data_source_uid_6fd21634_fk_data_sour; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: sub_domains sub_domains_dns_record_uid_1e70b745_fk_dns_recor; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: sub_domains sub_domains_organization_uid_abe259f1_fk_organization_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: sub_domains sub_domains_root_domain_uid_91cde39c_fk_root_doma; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: ticket ticket_cve_id_cd0dbbf5_fk_cve_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: ticket_event ticket_event_ticket_id_0244b672_fk_ticket_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: ticket_event ticket_event_vuln_scan_id_7f408339_fk_dmz_mini_dl_vulnscan_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--

ALTER TABLE ONLY public.ticket_event
    ADD CONSTRAINT ticket_event_vuln_scan_id_7f408339_fk_dmz_mini_dl_vulnscan_id FOREIGN KEY (vuln_scan_id) REFERENCES public.dmz_mini_dl_vulnscan(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: ticket ticket_ip_id_3aa822df_fk_ip_ip_hash; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: ticket ticket_organization_id_3759c8ee_fk_organization_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: top_cves top_cves_data_source_uid_753ec315_fk_data_sour; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: vulnerability vulnerability_domain_id_396cdcf6_fk_sub_domains_sub_domain_uid; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: vulnerability vulnerability_service_id_6cb061d7_fk_service_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: web_assets web_assets_data_source_uid_716854de_fk_data_sour; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: web_assets web_assets_organization_uid_5893b6b0_fk_organization_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: webpage webpage_discovered_by_id_d7969e8a_fk_scan_id; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: webpage webpage_domain_id_59407f86_fk_sub_domains_sub_domain_uid; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_alerts_mdl_assets xpanse_alerts_mdl_as_xpansealerts_id_b8d2b7f7_fk_xpanse_al; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_alerts_mdl_assets xpanse_alerts_mdl_as_xpanseassetsmdl_id_551795c3_fk_xpanse_as; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_alerts_mdl_business_units xpanse_alerts_mdl_bu_xpansealerts_id_c7cdac35_fk_xpanse_al; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_alerts_mdl_business_units xpanse_alerts_mdl_bu_xpansebusinessunits__90fd8627_fk_xpanse_bu; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_alerts_mdl_services xpanse_alerts_mdl_se_xpansealerts_id_65bfcebc_fk_xpanse_al; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_alerts_mdl_services xpanse_alerts_mdl_se_xpanseservicesmdl_id_0da6657e_fk_xpanse_se; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_business_units xpanse_business_unit_cyhy_db_name_76db20e6_fk_organizat; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_cve_services_mdl xpanse_cve_services__xpanse_inferred_cve__dcd2d4fe_fk_xpanse_cv; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
--
-- Name: xpanse_cve_services_mdl xpanse_cve_services__xpanse_service_id_fafe4f16_fk_xpanse_se; Type: FK CONSTRAINT; Schema: public; Owner: mdl_local
--
...
export const handler: Handler = async (event) => {
  ...
  try {
    console.log('Dropping existing local Mini Data Lake');
    await client.query(`drop owned by mdl_local;`);
  } catch (error) {
  ...
  try {
    console.log('Bootstrapping local Mini Data Lake');
    const sql = String(MINI_DATA_LAKE_SCHEMA);
    await client.query(sql);
  } catch (error) {
    console.log('Error running SQL for creation');
  }
