...
def populate_ServicesStatscache():
    try:
        ...
        services_data = [{'id': item['service'], 'value': item['value']} for
                         item in services_list]
    ...
    try:
        ...
        for vuln in latest_vulnerabilities:
            vulnerabilities_data.append({
                ...
                'organizationId': str(
                    vuln.domainId.organizationId.id) if vuln.domainId and vuln.domainId.organizationId else None,
...
def populate_MostCommonVulnerabilitiesCache():
    ...
    try:
        ...
        for vuln in vulnerabilities_data:
            ...
            vuln['organizationId'] = str(
                vuln.pop('domainId__organizationId__id', None))
