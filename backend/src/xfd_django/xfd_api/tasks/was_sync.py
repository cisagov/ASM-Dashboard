            ...
            try:
                ...
                (
                    ...
                    defaults={
                        ...
                        'last_detected': convert_timestamp_to_date(asset.get('last_detected')),
                        'first_detected': convert_timestamp_to_date(asset.get('first_detected')),
                        'potential': asset.get('potential'),
                        'cwe_list': asset.get('cwe_list'),
                        'wasc_list': asset.get('wasc_list'),
                        'last_tested': convert_timestamp_to_date(asset.get('last_tested')),
                        'fixed_date': convert_timestamp_to_date(asset.get('fixed_date')),
